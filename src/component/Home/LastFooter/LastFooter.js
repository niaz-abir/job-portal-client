    ...
    <section class="pt-16 pb-7  shadow-2xl shadow-dark-mid">
      <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div class="flex flex-col sm:flex-row items-center justify-between pb-14 border-b border-gray-500 gap-8">
          <div>
            <h2 className="text-3xl font-bold text-accent-400">InnRecruit</h2>
          </div>
          <div class="flex items-center gap-4">
            <a
              href="javascript:;"
              class="p-3 rounded-full bg-accent-400 text-black text-2xl group transition-all duration-500 hover:bg-amber-500 hover:text-white focus-within:outline-0 focus-within:bg-amber-500 focus-within:text-white"
            >
              <FaFacebookF />
            </a>
            <a
              href="javascript:;"
              class="p-3 rounded-full bg-accent-400 text-black text-2xlgroup transition-all duration-500 hover:bg-amber-500 hover:text-white focus-within:outline-0 focus-within:bg-amber-500 focus-within:text-white"
            >
              <FaInstagram />
            </a>
            <a
